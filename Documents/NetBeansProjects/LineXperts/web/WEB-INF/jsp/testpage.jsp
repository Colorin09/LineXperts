<%-- 
    Document   : testpage
    Created on : Dec. 17, 2020, 10:31:39 p.m.
    Author     : ma_ca
--%>
...
<html>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <body class="container-fluid">
        <div class="container" id="mainbody">
            ...
            <h2 class="text-center">Sample report generation</h2>
        <form>
  <div class="form-group">
    <label for="exampleFormControlSelect1">Example timelapse</label>
    <input type="date" />
    <input type="date" />
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <label for="exampleFormControlTextarea1">Example text area (additional info/comments)</label>
